...
local groups = {
  ...
  CmpItemKindField = "@varialbe.member",
  ...
  CmpItemKindUnit = "@lsp.type.struct",
  CmpItemKindValue = "@string",
  CmpItemKindEnum = "@lsp.type.enum",
  CmpItemKindKeyword = "@lsp.type.keyword",
  CmpItemKindSnippet = "Conceal",
  CmpItemKindColor = "Special",
  CmpItemKindFile = "Normal",
  CmpItemKindReference = "@markup.link",
  ...
  CmpItemKindArray = "@punctuation.bracket",
  CmpItemKindBoolean = "@boolean",
  CmpItemKindKey = "@varialbe.member",
  CmpItemKindNamespace = "@module",
  CmpItemKindString = "@string",
  CmpItemKindNull = "@constant.builtin",
  CmpItemKindNumber = "@number",
  CmpItemKindObject = "@constant",
  CmpItemKindPackage = "@module",
  ...
  NavicIconsUnit = "CmpItemKindUnit",
  NavicIconsValue = "CmpItemKindValue",
  NavicIconsEnum = "CmpItemKindEnum",
  NavicIconsKeyword = "CmpItemKindKeyword",
  NavicIconsSnippet = "CmpItemKindSnippet",
  NavicIconsColor = "CmpItemKindColor",
  NavicIconsFile = "CmpItemKindFile",
  NavicIconsReference = "CmpItemKindReference",
  NavicIconsFolder = "CmpItemKindFolder",
  ...
  NavicIconsArray = "CmpItemKindArray",
  NavicIconsBoolean = "CmpItemKindBoolean",
  NavicIconsKey = "CmpItemKindKey",
  NavicIconsNamespace = "CmpItemKindNamespace",
  NavicIconsString = "CmpItemKindString",
  NavicIconsNull = "CmpItemKindNull",
  NavicIconsNumber = "CmpItemKindNumber",
  NavicIconsObject = "CmpItemKindObject",
  NavicIconsPackage = "CmpItemKindPackage",
